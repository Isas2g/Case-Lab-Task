      ...
      <main className="flex-shrink-0">
        <Switch>
          ...
          <Route
            exact
            path="/tracks"
            component={token ? (my: boolean) => <Tracks my={false} /> : Login}
          />
          <Route
            exact
            path="/tracks/new"
            component={token ? CreateTrack : Login}
          />
          <Route
            exact
            path="/tracks/my"
            component={token ? (my: boolean) => <Tracks my={true} /> : Login}
          />
          <Route
            exact
            path="/tracks/:id"
            component={token ? GetTrack : Login}
          />
          <Route
            exact
            path="/tracks/edit/:id"
            component={token ? UpdateTrack : Login}
          />
          <Route
            exact
            path="/tracks/trackDetail/:id"
            component={token ? TrackDetailPage : Login}
          />
